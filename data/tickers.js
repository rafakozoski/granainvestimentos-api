...
const TICKERS = [
  ...
  // PoW
  { code: 'BTC-USD',    name: 'Bitcoin',                          type: 'cripto', sector: 'Criptos', subsector: 'Prova de Trabalho',        segment: 'Cripto', cnpj: null, coinGeckoId: 'bitcoin' },
  { code: 'ETH-USD',    name: 'Ethereum',                         type: 'cripto', sector: 'Criptos', subsector: 'Smart Contracts',          segment: 'Cripto', cnpj: null, coinGeckoId: 'ethereum' },
  { code: 'DOGE-USD',   name: 'Dogecoin',                         type: 'cripto', sector: 'Criptos', subsector: 'Meme',                     segment: 'Cripto', cnpj: null, coinGeckoId: 'dogecoin' },
  { code: 'LTC-USD',    name: 'Litecoin',                         type: 'cripto', sector: 'Criptos', subsector: 'Prova de Trabalho',        segment: 'Cripto', cnpj: null, coinGeckoId: 'litecoin' },
  { code: 'BCH-USD',    name: 'Bitcoin Cash',                     type: 'cripto', sector: 'Criptos', subsector: 'Prova de Trabalho',        segment: 'Cripto', cnpj: null, coinGeckoId: 'bitcoin-cash' },
  { code: 'XMR-USD',    name: 'Monero',                           type: 'cripto', sector: 'Criptos', subsector: 'Privacidade',              segment: 'Cripto', cnpj: null, coinGeckoId: 'monero' },
  { code: 'ZEC-USD',    name: 'Zcash',                            type: 'cripto', sector: 'Criptos', subsector: 'Privacidade',              segment: 'Cripto', cnpj: null, coinGeckoId: 'zcash' },
  { code: 'ETC-USD',    name: 'Ethereum Classic',                 type: 'cripto', sector: 'Criptos', subsector: 'Prova de Trabalho',        segment: 'Cripto', cnpj: null, coinGeckoId: 'ethereum-classic' },
  { code: 'KAS-USD',    name: 'Kaspa',                            type: 'cripto', sector: 'Criptos', subsector: 'Prova de Trabalho',        segment: 'Cripto', cnpj: null, coinGeckoId: 'kaspa' },
  // Smart Contracts / PoS
  { code: 'SOL-USD',    name: 'Solana',                           type: 'cripto', sector: 'Criptos', subsector: 'Smart Contracts',          segment: 'Cripto', cnpj: null, coinGeckoId: 'solana' },
  { code: 'BNB-USD',    name: 'BNB',                              type: 'cripto', sector: 'Criptos', subsector: 'Exchange Token',           segment: 'Cripto', cnpj: null, coinGeckoId: 'binancecoin' },
  { code: 'XRP-USD',    name: 'XRP',                              type: 'cripto', sector: 'Criptos', subsector: 'Pagamentos',               segment: 'Cripto', cnpj: null, coinGeckoId: 'ripple' },
  { code: 'ADA-USD',    name: 'Cardano',                          type: 'cripto', sector: 'Criptos', subsector: 'Smart Contracts',          segment: 'Cripto', cnpj: null, coinGeckoId: 'cardano' },
  { code: 'TRX-USD',    name: 'TRON',                             type: 'cripto', sector: 'Criptos', subsector: 'Smart Contracts',          segment: 'Cripto', cnpj: null, coinGeckoId: 'tron' },
  { code: 'TON-USD',    name: 'Toncoin',                          type: 'cripto', sector: 'Criptos', subsector: 'Smart Contracts',          segment: 'Cripto', cnpj: null, coinGeckoId: 'the-open-network' },
  { code: 'AVAX-USD',   name: 'Avalanche',                        type: 'cripto', sector: 'Criptos', subsector: 'Smart Contracts',          segment: 'Cripto', cnpj: null, coinGeckoId: 'avalanche-2' },
  { code: 'DOT-USD',    name: 'Polkadot',                         type: 'cripto', sector: 'Criptos', subsector: 'Interoperabilidade',       segment: 'Cripto', cnpj: null, coinGeckoId: 'polkadot' },
  { code: 'HBAR-USD',   name: 'Hedera',                           type: 'cripto', sector: 'Criptos', subsector: 'Smart Contracts',          segment: 'Cripto', cnpj: null, coinGeckoId: 'hedera-hashgraph' },
  { code: 'SUI-USD',    name: 'Sui',                              type: 'cripto', sector: 'Criptos', subsector: 'Smart Contracts',          segment: 'Cripto', cnpj: null, coinGeckoId: 'sui' },
  { code: 'NEAR-USD',   name: 'NEAR Protocol',                    type: 'cripto', sector: 'Criptos', subsector: 'Smart Contracts',          segment: 'Cripto', cnpj: null, coinGeckoId: 'near' },
  { code: 'APT-USD',    name: 'Aptos',                            type: 'cripto', sector: 'Criptos', subsector: 'Smart Contracts',          segment: 'Cripto', cnpj: null, coinGeckoId: 'aptos' },
  { code: 'ALGO-USD',   name: 'Algorand',                         type: 'cripto', sector: 'Criptos', subsector: 'Smart Contracts',          segment: 'Cripto', cnpj: null, coinGeckoId: 'algorand' },
  { code: 'XLM-USD',    name: 'Stellar',                          type: 'cripto', sector: 'Criptos', subsector: 'Pagamentos',               segment: 'Cripto', cnpj: null, coinGeckoId: 'stellar' },
  { code: 'ICP-USD',    name: 'Internet Computer',                type: 'cripto', sector: 'Criptos', subsector: 'Computação Descentralizada', segment: 'Cripto', cnpj: null, coinGeckoId: 'internet-computer' },
  { code: 'VET-USD',    name: 'VeChain',                          type: 'cripto', sector: 'Criptos', subsector: 'Supply Chain',             segment: 'Cripto', cnpj: null, coinGeckoId: 'vechain' },
  { code: 'XDC-USD',    name: 'XDC Network',                      type: 'cripto', sector: 'Criptos', subsector: 'Smart Contracts',          segment: 'Cripto', cnpj: null, coinGeckoId: 'xdce-crowd-sale' },
  { code: 'FLR-USD',    name: 'Flare',                            type: 'cripto', sector: 'Criptos', subsector: 'Smart Contracts',          segment: 'Cripto', cnpj: null, coinGeckoId: 'flare-networks' },
  { code: 'PI-USD',     name: 'Pi Network',                       type: 'cripto', sector: 'Criptos', subsector: 'Smart Contracts',          segment: 'Cripto', cnpj: null, coinGeckoId: 'pi-network' },
  // Layer 2
  { code: 'MATIC-USD',  name: 'Polygon (MATIC)',                  type: 'cripto', sector: 'Criptos', subsector: 'Layer 2',                  segment: 'Cripto', cnpj: null, coinGeckoId: 'matic-network' },
  { code: 'POL-USD',    name: 'POL (Polygon)',                    type: 'cripto', sector: 'Criptos', subsector: 'Layer 2',                  segment: 'Cripto', cnpj: null, coinGeckoId: 'polygon-ecosystem-token' },
  { code: 'MNT-USD',    name: 'Mantle',                           type: 'cripto', sector: 'Criptos', subsector: 'Layer 2',                  segment: 'Cripto', cnpj: null, coinGeckoId: 'mantle' },
  { code: 'ARB-USD',    name: 'Arbitrum',                         type: 'cripto', sector: 'Criptos', subsector: 'Layer 2',                  segment: 'Cripto', cnpj: null, coinGeckoId: 'arbitrum' },
  // DeFi / Oráculos
  { code: 'LINK-USD',   name: 'Chainlink',                        type: 'cripto', sector: 'Criptos', subsector: 'Oráculos',                 segment: 'Cripto', cnpj: null, coinGeckoId: 'chainlink' },
  { code: 'UNI-USD',    name: 'Uniswap',                          type: 'cripto', sector: 'Criptos', subsector: 'DeFi / DEX',               segment: 'Cripto', cnpj: null, coinGeckoId: 'uniswap' },
  { code: 'AAVE-USD',   name: 'Aave',                             type: 'cripto', sector: 'Criptos', subsector: 'DeFi / Lending',           segment: 'Cripto', cnpj: null, coinGeckoId: 'aave' },
  { code: 'ATOM-USD',   name: 'Cosmos Hub',                       type: 'cripto', sector: 'Criptos', subsector: 'Interoperabilidade',       segment: 'Cripto', cnpj: null, coinGeckoId: 'cosmos' },
  { code: 'RENDER-USD', name: 'Render',                           type: 'cripto', sector: 'Criptos', subsector: 'IA / Computação',          segment: 'Cripto', cnpj: null, coinGeckoId: 'render-token' },
  { code: 'FET-USD',    name: 'Artificial Superintelligence Alliance', type: 'cripto', sector: 'Criptos', subsector: 'IA / Computação', segment: 'Cripto', cnpj: null, coinGeckoId: 'fetch-ai' },
  { code: 'TAO-USD',    name: 'Bittensor',                        type: 'cripto', sector: 'Criptos', subsector: 'IA / Computação',          segment: 'Cripto', cnpj: null, coinGeckoId: 'bittensor' },
  { code: 'HYPE-USD',   name: 'Hyperliquid',                      type: 'cripto', sector: 'Criptos', subsector: 'DeFi / DEX',               segment: 'Cripto', cnpj: null, coinGeckoId: 'hyperliquid' },
  { code: 'ENA-USD',    name: 'Ethena',                           type: 'cripto', sector: 'Criptos', subsector: 'DeFi',                     segment: 'Cripto', cnpj: null, coinGeckoId: 'ethena' },
  { code: 'MORPHO-USD', name: 'Morpho',                           type: 'cripto', sector: 'Criptos', subsector: 'DeFi / Lending',           segment: 'Cripto', cnpj: null, coinGeckoId: 'morpho' },
  { code: 'ONDO-USD',   name: 'Ondo',                             type: 'cripto', sector: 'Criptos', subsector: 'DeFi / RWA',               segment: 'Cripto', cnpj: null, coinGeckoId: 'ondo-finance' },
  { code: 'JUP-USD',    name: 'Jupiter',                          type: 'cripto', sector: 'Criptos', subsector: 'DeFi / DEX',               segment: 'Cripto', cnpj: null, coinGeckoId: 'jupiter-exchange-solana' },
  { code: 'SKY-USD',    name: 'Sky',                              type: 'cripto', sector: 'Criptos', subsector: 'DeFi / Lending',           segment: 'Cripto', cnpj: null, coinGeckoId: 'sky' },
  { code: 'JST-USD',    name: 'JUST',                             type: 'cripto', sector: 'Criptos', subsector: 'DeFi / Lending',           segment: 'Cripto', cnpj: null, coinGeckoId: 'just' },
  // Armazenamento / Infra
  { code: 'FIL-USD',    name: 'Filecoin',                         type: 'cripto', sector: 'Criptos', subsector: 'Armazenamento',            segment: 'Cripto', cnpj: null, coinGeckoId: 'filecoin' },
  { code: 'QNT-USD',    name: 'Quant',                            type: 'cripto', sector: 'Criptos', subsector: 'Interoperabilidade',       segment: 'Cripto', cnpj: null, coinGeckoId: 'quant-network' },
  { code: 'ZRO-USD',    name: 'LayerZero',                        type: 'cripto', sector: 'Criptos', subsector: 'Interoperabilidade',       segment: 'Cripto', cnpj: null, coinGeckoId: 'layerzero' },
  // Exchange Tokens
  { code: 'BGB-USD',    name: 'Bitget Token',                     type: 'cripto', sector: 'Criptos', subsector: 'Exchange Token',           segment: 'Cripto', cnpj: null, coinGeckoId: 'bitget-token' },
  { code: 'OKB-USD',    name: 'OKB',                              type: 'cripto', sector: 'Criptos', subsector: 'Exchange Token',           segment: 'Cripto', cnpj: null, coinGeckoId: 'okb' },
  { code: 'GT-USD',     name: 'Gate',                             type: 'cripto', sector: 'Criptos', subsector: 'Exchange Token',           segment: 'Cripto', cnpj: null, coinGeckoId: 'gatechain-token' },
  { code: 'KCS-USD',    name: 'KuCoin Token',                     type: 'cripto', sector: 'Criptos', subsector: 'Exchange Token',           segment: 'Cripto', cnpj: null, coinGeckoId: 'kucoin-shares' },
  { code: 'LEO-USD',    name: 'LEO Token',                        type: 'cripto', sector: 'Criptos', subsector: 'Exchange Token',           segment: 'Cripto', cnpj: null, coinGeckoId: 'leo-token' },
  { code: 'CRO-USD',    name: 'Cronos',                           type: 'cripto', sector: 'Criptos', subsector: 'Exchange Token',           segment: 'Cripto', cnpj: null, coinGeckoId: 'crypto-com-chain' },
  { code: 'NEXO-USD',   name: 'NEXO',                             type: 'cripto', sector: 'Criptos', subsector: 'DeFi / Lending',           segment: 'Cripto', cnpj: null, coinGeckoId: 'nexo' },
  // Meme
  { code: 'SHIB-USD',   name: 'Shiba Inu',                        type: 'cripto', sector: 'Criptos', subsector: 'Meme',                     segment: 'Cripto', cnpj: null, coinGeckoId: 'shiba-inu' },
  { code: 'PEPE-USD',   name: 'Pepe',                             type: 'cripto', sector: 'Criptos', subsector: 'Meme',                     segment: 'Cripto', cnpj: null, coinGeckoId: 'pepe' },
  { code: 'BONK-USD',   name: 'Bonk',                             type: 'cripto', sector: 'Criptos', subsector: 'Meme',                     segment: 'Cripto', cnpj: null, coinGeckoId: 'bonk' },
  { code: 'TRUMP-USD',  name: 'Official Trump',                   type: 'cripto', sector: 'Criptos', subsector: 'Meme',                     segment: 'Cripto', cnpj: null, coinGeckoId: 'official-trump' },
  // Outros
  { code: 'WLD-USD',    name: 'Worldcoin',                        type: 'cripto', sector: 'Criptos', subsector: 'Identidade Digital',       segment: 'Cripto', cnpj: null, coinGeckoId: 'worldcoin-wld' },
];
